...
function NameCard() {
  return (
    <div className="card border border-base-200 overflow-hidden relative isolate">
      {/* fundo: gradiente + pattern */}
      <div className="absolute inset-x-0 top-0 h-20 z-0 bg-gradient-to-r from-primary/90 via-secondary/80 to-accent/80">
        <div
      ...
      {/* antes: pt-0  | depois: pt-6 (ou pt-8) */}
      <div className="card-body relative z-10 pt-6">
        {/* antes: -mt-10 flex ... | depois: sem -mt-10 */}
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 text-base-content">
          ...
          <div className="ms-auto">
            <Link href="/app/profile" className="btn btn-primary btn-sm normal-case">
              Editar perfil
            </Link>
          </div>
        </div>
...
function ReputationCard() {
  const scorePct = Math.round((reputationMock.score / 5) * 100);
  return (
